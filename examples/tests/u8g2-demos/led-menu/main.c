...
int main(void) {
  ...
  while(1) {
    ...
    if (checkbox_led0) led_on(0); else led_off(0);
    if (checkbox_led1) led_on(1); else led_off(1);
    if (checkbox_led2) led_on(2); else led_off(2);
    if (checkbox_led3) led_on(3); else led_off(3);
