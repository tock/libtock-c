...
int prior_temperature;
int prior_local_temperature_setpoint;
int prior_global_temperature_setpoint;
...
static void sensor_callback(__attribute__ ((unused)) int pid,
  ...
  if (measured_temperature != prior_temperature) {
    prior_temperature = measured_temperature;
    print_status();
  }
}
...
static void button_callback(int                            btn_num,
  ...
  if (local_temperature_setpoint != prior_local_temperature_setpoint) {
