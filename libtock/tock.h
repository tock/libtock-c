...
returncode_t tock_command_return_u32_u32_u32_to_returncode(syscall_return_t, uint32_t*, uint32_t*, uint32_t*);
...
// SyscallReturn variants.
returncode_t tock_command_return_u32_u64_to_returncode(syscall_return_t, uint32_t*, uint64_t*);
